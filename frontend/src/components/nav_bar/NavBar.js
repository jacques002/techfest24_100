    ...
    return (
        <div>
            <div className={styles.navbar}>
                ...
                <div className={styles.LogoName} onClick={()=>{setActiveMenu("Dictionary")}}>
                ...
                <div className={styles.LogoName} onClick={()=>{setActiveMenu("Scenarios")}}>
                ...
                <div className={styles.LogoName} onClick={()=>{setActiveMenu("Stories")}}>
